...
public class CommonSetNewActivity extends BaseActivity {
    ...
    @BindView(R.id.ll_app_user)
    LinearLayout ll_app_user;
    ...
    protected int getLayoutRes() {
        return R.layout.common_set_new_activity;
    }
...
//        L.w("updateChargeTime -> start = " + start + " , end = " + end);
    ...
    @OnClick({R.id.action_back, R.id.bt_switch, R.id.ll_app_user})
